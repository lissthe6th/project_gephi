...
Эта часть кода призвана присваивать айди уникальным значениям слов. В словарь добавляется слово, если программа не находит существующего аналога. После выполнения макс айди увеличивается на 1 и так, пока не закончатся слова.
...
Здесь мы переходим непосредственно в интерфейс gephi. Для начала нужно загрузить cvs таблицы в новый проект. Внутри возникает необработанный и некрасивый граф, а также можно работать непосредственно с таблицей индексов и связей.
...
Таким образом, данный инструментарий подходит для решения задач в поле культурологии.
